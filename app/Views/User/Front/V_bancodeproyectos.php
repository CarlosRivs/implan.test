<?=$this->extend('User/Front/layout/main-BDP')?>
<!-- Services-->
<?=$this->section('css')?>
<link href="<?php echo base_url()?>/css/stylesPRO.css" rel="stylesheet"/>
<?=$this->endSection()?>
...
<?=$this->section('content')?>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Es un organismo público que 
                            orienta la Planeación Estratégica 
                            Multidisciplinaria a mediano y 
                            largo plazo de las ciudades. 
                            Traspasa períodos políticos para 
                            sentar las bases de la 
                            participación ciudadana en la 
                            planificación de la ciudad, 
                            garantizando la continuidad de 
                            proyectos de gran aliento y de 
                            transformación.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                        ...
                        <p class="text-muted">En cualquier alcaldía del país, el 
                            proceso trienal de cambio de 
                            administración genera 
                            Inevitablemente un ciclo 
                            recurrente de ‘reinvención’ del 
                            proyecto municipal cada tres 
                            años, con todos los costos que 
                            esto representa.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                        ...
                        <p class="text-muted">• Apoyar a la administración 
                            municipal a alcanzar sus 
                            objetivos.

                        <p class="text-muted">• Vinculación, gestión y 
                        ...
                        <p class="text-muted">• Atracción de recursos 
                            internacionales para 
                            proyectos estratégicos.

                        <p class="text-muted">• Capitalización política, social 
                            y económica de la Alcaldesa.</p>
                    </div>
                </div>
            </div>
        </section>
        <!-- Portfolio Grid PROYECTIS-->
        ...
        <!-- Portfolio Grid OBRAS EN PROCESO-->
